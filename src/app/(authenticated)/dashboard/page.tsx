        ...
        {(accountId || category) && data && (
          <div className="flex flex-wrap items-center gap-4 bg-white/60 backdrop-blur-md p-4 rounded-[2rem] shadow-sm border border-white/50">
            ...
            <div className="flex flex-wrap gap-2.5">
              {accountId && (
                <div className="flex items-center gap-2.5 px-3.5 py-1.5 bg-white border border-slate-100 rounded-xl shadow-sm">
                  <div
                    ...
                    style={{
                      backgroundColor:
                        data.accounts.find((a) => a.id === accountId)?.color || "#10b981",
                    }}
                  />
                  ...
                  <button
                    onClick={() => {
                      ...
                      p.delete("accountId");
                      router.push(p.toString() ? `?${p}` : "/dashboard");
                    }}
              ...
              {category && (
                <div className="flex items-center gap-2.5 px-3.5 py-1.5 bg-emerald-50 border border-emerald-100/50 rounded-xl shadow-sm">
                  ...
                  <button
                    ...
                    className="ml-1 p-0.5 rounded-md hover:bg-emerald-100 text-emerald-300 hover:text-emerald-500 transition-colors"
                  >
                    <X className="w-3 h-3" />
                  </button>
                </div>
            ...
            >
              <span className="text-[10px] font-black tracking-widest">LIMPAR TUDO</span>
